...
layui.define("jquery", function (e) {
    ...
    D.prototype.config = {
        ...
        i(c)[0] && i(c).data("templates.admin.index") == e.index ? e.removePicker(D.thisElemInd) : (e.removePicker(D.thisElemInd), i("body").append(t)), D.thisElemInd = e.index, D.thisColor = r.style.background, e.position(), e.pickerEvents()
...
layui.define(["laytpl", "form"], function (e) {
    ...
    x.prototype.config = {
        ...
        e.elem.on("click", 'input[lay-filter="layTransferCheckbox"]+', function () {
            ...
            var n = a(this), i = n.data("templates.admin.index"), l = e.layBox.eq(i), r = [];
            if (!n.hasClass(o)) {
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    F.prototype.config = {
        ...
        var v = function (e) {
            var a = t(this), l = a.parents("tr").eq(0).data("templates.admin.index"),
                n = i.layBody.find('tr[data-index="' + l + '"]'), o = d.cache[i.key] || [];
        ...
        i.elem.on("click", 'input[name="layTableCheckbox"]+', function () {
            var e = t(this).prev(), a = i.layBody.find('input[name="layTableCheckbox"]'),
                l = e.parents("tr").eq(0).data("templates.admin.index"), n = e[0].checked,
            ...
            var e = t(this).prev(), a = e[0].checked, l = d.cache[i.key],
                n = e.parents("tr").eq(0).data("templates.admin.index");
        ...
        i.layBody.on("change", "." + R, function () {
            var e = t(this), a = this.value, l = e.parent().data("field"),
                n = e.parents("tr").eq(0).data("templates.admin.index"), o = d.cache[i.key][n];
            o[l] = a, layui.event.call(this, y, "edit(" + p + ")", v.call(this, {value: a, field: l}))
        }).on("blur", "." + R, function () {
            var e, a = t(this), l = this, n = a.parent().data("field"),
                o = a.parents("tr").eq(0).data("templates.admin.index"), r = d.cache[i.key][o];
        ...
        i.layBody.on("click", "." + g, function (e) {
            ...
            var e = t(this), a = e.parents("tr").eq(0).data("templates.admin.index");
